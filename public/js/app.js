...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // HTMLの読み込みが終わった後に実行される処理を設定


window.addEventListener('DOMContentLoaded', function (event) {
  // delete-quiz の class があたっているタグ(ボタン)をすべて取得(配列)
  var deleteButtons = document.querySelectorAll('.delete-quiz'); // ボタンを一つずつ処理する
  ...
  deleteButtons.forEach(function (deleteButton) {
    ...
    deleteButton.addEventListener('click', function (event) {
      ...
      axios["delete"]('/quizzes/' + quizId).then(function (response) {
        ...
        row.parentNode.removeChild(row); // メッセージ表示
